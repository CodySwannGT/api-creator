# api-creator Wiki — LLM Wiki Contract
...
## What this is
A git-native markdown knowledge base under `wiki/`, owned by **api-creator**, maintained by the
...
## Sources & connectors
Enabled connectors: git, memory, roles, docs.
