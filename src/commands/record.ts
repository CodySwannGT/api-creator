...
export const recordCommand = new Command('record')
  ...
  .option('--output <path>', 'Output path for the recorded HAR file', './recordings')
  .option('--include-assets', 'Include static asset requests (images, CSS, etc.)', false)
  .action(async (options) => {
    ...
    console.log(
      chalk.white(`  api-creator generate --input ${harPath}`),
    );
    console.log('');
  });
